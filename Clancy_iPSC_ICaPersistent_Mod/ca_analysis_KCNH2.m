function [ ca_results, validation_data ]= ca_analysis_KCNH2( Time, Iup, INaCa, IpCa, Ca, plot_title )
...
% --- Re-zero and Re-normalize the truncated data ---
...
%% =======================================================================
%  PLOT TO VISUALIZE THE BI-EXPONENTIAL FIT
%  =======================================================================
figure, set(gcf,'color','w');
hold on;
